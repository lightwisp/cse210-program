...
public class Reflection : Mindfulness
{
    ...
    {
        prompts.AddRange(new List<string> {"Think of a time when you stood up for someone else.",
            "Think of a time when you did something really difficult.",
            "Think of a time when you helped someone in need.",
            "Think of a time when you did something truly selfless." });

        questions.AddRange(new List<string> {"Why was this experience meaningful to you?",
    ...
    {
        ReadyMessage();
        DisplayString(prompts);
        Menus.WaitingAnimation(15);
        for (int i = GetLoop(10); i > 0; i--)
        {
            DisplayString(questions);
